...
import { CRMSERVICES } from "../../lib/utils";
import { serviceDetailsCRM } from "../../lib/utils2";
import { Helmet } from "react-helmet";
import { CrmServicesHeading } from "./ServicesHeading";
...
const ExpandableCards = () => {
  ...
  return (
    <>
      <Helmet>
        <title>CRM Services - Evren Research</title>
        <meta
          name="description"
          content="Explore Evren Research's CRM services to streamline your recruitment processes."
        />
        <link
          rel="canonical"
          href="https://www.evrenresearch.com/crm-services"
        />
          ...
          {`
                {
                  ...
                  "@type": "WebPage",
                  "url": "https://www.evrenresearch.com/crm-services",
                  "name": "CRM Services - Evren Research",
                  "description": "Explore Evren Research's CRM services to streamline your recruitment processes."
                }
              `}
        </script>
      </Helmet>
